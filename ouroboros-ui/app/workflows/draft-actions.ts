 ...
 *
 * Every refusal comes back as `{ ok: false, refusal }` — `action-outcome.ts` holds the shape and the
 * rule, shared with the code editor's save (V.4, [#172](https://github.com/NobuData/ouroboros/issues/172)).
 */
